...
### - fLoadTOF()     : load PTR-TOF spectra
### - fNormTOF()     : normalize and average PTR-TOF spectra
...
fLoadTOF <- function(spect.dir, spect.name) {
  ...
  ## instrument
  ##
  ## PTR-TOF-MS spectra files are in CSV format:
  ##   scan n.     m/z         m/z         m/z
  ##     0          1           2           3
...
fLoadCIMS <- function(cims.dir, cims.fn) {
  ## load data file generated by the Leicester CIMS instrument
  ##
  ## input:
...
fSpectraCIMS <- function(cims.dir, cims.lst) {
  ## load spectra generated by the Leicester CIMS instrument and
  ## retrieve the start/stop times of each spectrum scan
  ##
  ...
  ##                        data.frame ( amu, ion count, ion count, ... ) )
  ## ------------------------------------------------------------
  if (!is.list(cims.lst)) {
...
fDiagnCIMS <- function(cims.df, fn.str) {
  ...
  ## variables; save plot of diagnostic variables to png if filename
  ## is given
  ##
  ## NB: see documentation of fLoadCIMS()
  ##
...
fNormCIMS <- function(cims.df, ref.mz, norm.fac, scale.str) {
  ...
  ##                             diagnostic variables, vaisala variables,
